...
const FeatureCard = ({ icon: Icon, title, description, delay = 0 }) => {
  return (
    ...
    >
      <div className="w-16 h-16 rounded-2xl bg-theme-card/80 flex items-center justify-center mb-6 border border-slate-700/50 group-hover:border-cyan-500/50 transition-colors">
